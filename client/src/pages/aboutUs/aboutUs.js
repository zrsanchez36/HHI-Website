...
function AboutUs ({title, description, tags, imageUrl}) {
    ...
    return (
        <div className='about__us--page'>
            <section className='aboutus__header'>
                <div className='opaque__filter'>
                    ...
                    <div className='aboutus__title'>
                        <h1 className='super__heading'>WHO WE ARE</h1>
                    </div>
            </section>
            ...
            <div className='aboutus__page--container'>
                <motion.div ref={ref} style={{scale: scrollYProgress, opacity: scrollYProgress,}}className='aboutus__intro--container'>
